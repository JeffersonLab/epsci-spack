...
class Evio(Package):
    ...
    git      = "https://github.com/JeffersonLab/evio.git"
    ...
    version('6.0', branch = 'evio-6.0')
    version('5.2', branch = 'evio-5.2')
    ...
    # Depands on the disruptor software package
    depends_on('disruptor-cpp', when = '@6.0:')
    ...
    def install(self, spec, prefix):
        ...
        mkdirp(prefix.lib)
        install('./lib/libevio*', prefix.lib)
        install('./lib/libeviocc*', prefix.lib)
